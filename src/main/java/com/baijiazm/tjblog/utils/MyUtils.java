...
public class MyUtils {
     ...
     * 获取文件所在目录
     */
    private static String location = MyUtils.class.getClassLoader().getResource("").getPath();
...
//            默认是classPath路径
    ...
    public static DataSource getNewDataSource() {
        if (newDataSource == null) synchronized (MyUtils.class) {
            if (newDataSource == null) {
                Properties properties = MyUtils.getPropFromFile("application-default.properties");
